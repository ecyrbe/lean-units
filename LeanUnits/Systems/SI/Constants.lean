...
def_derived_unit speed_of_light := "c" from meter/second with scale 299792458
def_derived_unit planck_constant := "h" from joule*second with scale (662607015/10^42)
def_derived_unit hyperfine_transition_cesium := "Δν_Cs" from second^(-1) with scale 9192631770
def_derived_unit elementary_charge := "e" from coulomb with scale (1602176634/10^28)
def_derived_unit boltzmann_constant := "k" from joule/kelvin with scale (1380649/10^29)
def_derived_unit avogadro_constant := "N_A" from mole^(-1) with scale (602214076/10^31)
def_derived_unit luminous_efficacy := "K_cd" from lumen/watt with scale 683
